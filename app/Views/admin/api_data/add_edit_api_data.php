          ...
          <div class="card-body">
            <div class="basic-login-inner">
              <form id="currentPageFormSubadmin" name="currentPageFormSubadmin" class="form-auth-small" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row mt-2">
                  <div class="form-group-inner  col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('event_title')) : ?>error<?php endif; ?>">
                    ...
                    <?php if (session('validation') && session('validation')->hasError('event_title')) : ?>
                      <span for="event_title" generated="true" class="help-inline"><?php echo session('validation')->getError('event_title'); ?></span>
                    <?php endif; ?>
                  </div>
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('description')) : ?>error<?php endif; ?>">
                    <label>Description</label>
                    <input type="text" name="description" style="height: 70px;" id="description" value="<?php if (old('description')) : echo old('description');
                                                                                                        else : echo stripslashes($EDITDATA['description']);
                                                                                                        endif; ?>" class="form-control required" placeholder="Description">
                    <?php if (session('validation') && session('validation')->hasError('description')) : ?>
                      <span for="description" generated="true" class="help-inline"><?php echo session('validation')->getError('description'); ?></span>
                    <?php endif; ?>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('time_permission')) : ?>error<?php endif; ?>">
                    ...
                    <div class="radio">
                      ...
                      <?php if (session('validation') && session('validation')->hasError('time_permission')) : ?>
                        <span for="time_permission" generated="true" class="help-inline"><?php echo session('validation')->getError('time_permission'); ?></span>
                      <?php endif; ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-10 col-md-8 col-sm-12 col-xs-12  <?php if (session('validation') && session('validation')->hasError('repeating_event')) : ?>error<?php endif; ?>">
              ...
              <?php } ?>
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12   <?php echo ($EDITDATA['repeating_event'] == 'Yes') ? 'show' : 'hide'; ?> <?php if (session('validation') && session('validation')->hasError('content1')) : ?>error<?php endif; ?>" id="frequency">
                ...
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12  <?php echo ($EDITDATA['repeating_event'] == 'Yes') ? 'show' : 'hide'; ?> <?php if (session('validation') && session('validation')->hasError('no_of_repeat')) : ?>error<?php endif; ?>" id="repeat">
                  <label>Number of repeats:<span class="required">*</span></label>
                  <input type="text" name="no_of_repeat" id="no_of_repeat" value="<?php if (old('no_of_repeat')) : echo old('no_of_repeat');
                                                                                  else : echo stripslashes($EDITDATA['no_of_repeat']);
                                                                                  endif; ?>" class="form-control required" placeholder="Number of repeats:">
                  <?php if (session('validation') && session('validation')->hasError('no_of_repeat')) : ?>
                    <span for="no_of_repeat" generated="true" class="help-inline"><?php echo session('validation')->getError('no_of_repeat'); ?></span>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-1 additional_fields" style="display: none;">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('virtual_event_price')) : ?>
                    <span for="virtual_event_price" generated="true" class="help-inline"><?php echo session('validation')->getError('virtual_event_price'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12  additional_fields" style="display: none;">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('virtual_event_link')) : ?>
                    <span for="virtual_event_link" generated="true" class="help-inline"><?php echo session('validation')->getError('virtual_event_link'); ?></span>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('content1')) : ?>error<?php endif; ?>" id="frequency">
                  <label>Choose already saved location or type new one below:<span class=""></span></label>
              ...
              <div class="row">
                <div class="form-group-inner  col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('location_address')) : ?>error<?php endif; ?>">
                ...
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('latitude')) : ?>error<?php endif; ?>">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('longitude')) : ?>error<?php endif; ?>">
                ...
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('website')) : ?>error<?php endif; ?>">
                  <label>Website:</label>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('phone_number')) : ?>error<?php endif; ?>">
                ...
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('content1')) : ?>error<?php endif; ?>">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('cover_charge')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('cover_charge')) : ?>
                    <span for="cover_charge" generated="true" class="help-inline"><?php echo session('validation')->getError('cover_charge'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('set_time')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('set_time')) : ?>
                    <span for="set_time" generated="true" class="help-inline"><?php echo session('validation')->getError('set_time'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('video')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('video')) : ?>
                    <span for="video" generated="true" class="help-inline"><?php echo session('validation')->getError('video'); ?></span>
                  <?php endif; ?>
                </div>

                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('video2')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('video2')) : ?>
                    <span for="video2" generated="true" class="help-inline"><?php echo session('validation')->getError('video2'); ?></span>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('video3')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('video3')) : ?>
                    <span for="video3" generated="true" class="help-inline"><?php echo session('validation')->getError('video3'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('buy_now_link')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('buy_now_link')) : ?>
                    <span for="buy_now_link" generated="true" class="help-inline"><?php echo session('validation')->getError('buy_now_link'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('reserve_seat_link')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('reserve_seat_link')) : ?>
                    <span for="reserve_seat_link" generated="true" class="help-inline"><?php echo session('validation')->getError('reserve_seat_link'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('event_tags')) : ?>error<?php endif; ?>">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('qr_code_link')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session('validation') && session('validation')->hasError('qr_code_link')) : ?>
                    <span for="qr_code_link" generated="true" class="help-inline"><?php echo session('validation')->getError('qr_code_link'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('artist_id')) : ?>error<?php endif; ?>">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('event_source_id')) : ?>error<?php endif; ?>">
                  <label>Event Source Id<span class=""></span></label>
                  <input type="text" name="event_source_id" id="event_source_id" value="<?php if (old('event_source_id')) : echo old('event_source_id');
                                                                                        else : echo stripslashes($EDITDATA['event_source_id']);
                                                                                        endif; ?>" class="form-control" placeholder="Event Source Id">
                  <?php if (session('validation') && session('validation')->hasError('event_source_id')) : ?>
                    <span for="event_source_id" generated="true" class="help-inline"><?php echo session('validation')->getError('event_source'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('event_tags')) : ?>error<?php endif; ?>">
                  <label>Event Source<span class=""></span></label>
                  <input type="text" name="event_source" id="event_source" value="<?php if (old('event_source')) : echo old('event_source');
                                                                                  else : echo stripslashes($EDITDATA['event_source']);
                                                                                  endif; ?>" class="form-control" placeholder="Event Source">
                  <?php if (session('validation') && session('validation')->hasError('event_source')) : ?>
                    <span for="event_source" generated="true" class="help-inline"><?php echo session('validation')->getError('event_source'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-6 col-xs-12" <?php if (session('validation') && session('validation')->hasError('event_source_image')) : ?>error<?php endif; ?>>
                  <div class="animation">
                    <label>Event Source Image<span class="required">*</span></label>
                    <input value="<?php if (old('event_source_image')) : echo old('event_source_image');
                                    else : echo stripslashes($EDITDATA['event_source_image']);
                                    endif; ?>" id="uploadFile" name="event_source_image" class="f-input" readonly />
                ...
                <div class="col-lg-4 px-0">
                  <div class="fileUpload btn btn--browse">
                    <span>Browse</span>
                    <input id="uploadBtn" type="file" name="event_source_image" class="upload" />
                  </div>
                </div>
              </div>
