            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Advertisement List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                              ...
                              ?>
                               <tr role="row" class="<?php echo $rowClass; ?>">
                                  <td><?=$i++?></td>
                                  <td><?=stripslashes(strip_tags($ALLDATAINFO['title1']))?></td>
                                  <td><?=stripslashes(strip_tags($ALLDATAINFO['title2']))?></td>
                                  <td><?=substr($ALLDATAINFO['content1'], 0, 150);?>...</td>
                                  <td><?=substr($ALLDATAINFO['content2'], 0, 150);?>...</td>
                                  ...
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu dropdown-menu-show" role="menu">
                                        ...
                                        <?php if(!empty($ALLDATAINFO['is_active']) && ($ALLDATAINFO['is_active'] === true || $ALLDATAINFO['is_active'] === 't' || $ALLDATAINFO['is_active'] == '1')): ?>
                                          <li><a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['id'].'/0')?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
                                        <?php elseif(($ALLDATAINFO['is_active'] === false || $ALLDATAINFO['is_active'] === 'f' || $ALLDATAINFO['is_active'] == '0')): ?>
