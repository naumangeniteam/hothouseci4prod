...
class HowToGetPageController extends BaseController
{
    ...
    /**
     * Get How To Get Page Data
     */
    public function getHowToGetPageList()
    {
        ...
        if (requestAuthenticate(APIKEY, 'GET')) {
            ...
            $result['get_hh_tbl'] = $this->commonModel->getData(
                'multiple',
                'get_hh_tbl',
                ['where' => ['is_active' => '1']]
            );
