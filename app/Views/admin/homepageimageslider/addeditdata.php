            ...
            <div class="basic-login-inner">
              <form id="currentPageFormSubadmin" name="currentPageFormSubadmin" class="form-auth-small" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="row" id="show">
                  <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('position')) : ?>error<?php endif; ?>" id="show">
                    ...
                    <input type="text" name="position" id="position" value="<?php if (old('position')) : echo old('position');
                                                                            ...
                                                                            endif; ?>" class="form-control required" placeholder="Position">
                  ...
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('url')) : ?>error<?php endif; ?>" id="show">
                    <label>Slider Url<span class="required">*</span></label>
                    <input type="text" name="url" id="position" value="<?php if (old('url')) : echo old('url');
