            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Event Location Types List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Event Location Types </h5>
                    ...
                    <div id="simpletable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                            ...
                            <tbody>
                            <?php if (!empty($ALLDATA)): $i=$first; $j=0; foreach($ALLDATA as $ALLDATAINFO): 
