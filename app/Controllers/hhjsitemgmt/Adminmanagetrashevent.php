...
class Adminmanagetrashevent extends BaseController {
...
$this->lang->setLocale('admin');
	...
	{	
		...
		$data['error'] 						= 	'';
		$data['activeMenu'] 				= 	'adminmanagetrashevent';
		$data['activeSubMenu'] 				= 	'adminmanagetrashevent';
		...
		$baseUrl 							= 	base_url().'hhjsitemgmt/adminmanagetrashevent/index';
       ...
       if ($this->request->getUri()->getSegment($uriSegment)) :
		...
		$this->layouts->admin_view('trashevent/index',array(),$data);
	}	// END OF FUNCTION
