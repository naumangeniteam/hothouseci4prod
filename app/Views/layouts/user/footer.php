<script type="text/javascript">
    $(function(){
        <?php if($this->session->getFlashdata('alert_error')): ?>
            alertMessageModelPopup('<?php echo $this->session->getFlashdata('alert_error'); ?>','danger');
            <?php unset($_SESSION['alert_error']); ?>
        <?php elseif($this->session->getFlashdata('alert_warning')): ?>
            alertMessageModelPopup('<?php echo $this->session->getFlashdata('alert_warning'); ?>','warning');
            <?php unset($_SESSION['alert_warning']); ?>
        <?php elseif($this->session->getFlashdata('alert_success')): ?>
            alertMessageModelPopup('<?php echo $this->session->getFlashdata('alert_success'); ?>','success');
            <?php unset($_SESSION['alert_success']); ?>
        <?php elseif($this->session->getFlashdata('alert_message')): ?>
            alertMessageModelPopup('<?php echo $this->session->getFlashdata('alert_message'); ?>','info');
