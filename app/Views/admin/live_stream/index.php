      ...
      <div class="page-block">
        <div class="row align-items-center">
          <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="javascript:void(0);">Live Stream List</a></li>
            </ul>
          </div>
        </div>
      </div>
                ...
                <div class="widget-body bordered-left bordered-warning">
                  <form class="form-inline" method="get" id="validate" novalidate="novalidate">
                    ...
                    <div class="form-group">
                      ...
                      <a href="<?= base_url('hhjsitemgmt/adminmanagelivestream') ?>" class="btn btn-link">View All </a>
                    </div>
                  </form>
                  ...
                  <div class="row">
                    ...
                    <!-- <div class="col-sm-12 col-md-10 col-xs-12">
                      <div class="row" style="margin:3px;">
                        ...
                        <a href="<?php echo base_url('hhjsitemgmt/eventmanagement/import'); ?>" style="margin:3px;" class="btn btn-palegreen">Import</a>

                        <a href="<?= base_url('hhjsitemgmt/eventmanagement/index') ?>" style="margin:3px;" class="btn btn-palegreen">All Event(<?= count($events) ?>)</a>

                        <a href="<?= base_url('hhjsitemgmt/adminmanagepublishevent') ?>" style="margin:3px;" class="btn btn-primary pull-right">Published Event(<?= count($publishevent) ?>)</a>

                        <a href="<?= base_url('hhjsitemgmt/adminmanagetrashevent') ?>" style="margin:3px;" class="btn btn-primary pull-right">Trash Event(<?= count($trashevent) ?>)</a>
                                  ...
                                  <td style="width:100px;">
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu dropdown-menu-show" role="menu">
                                        <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagelivestream/addeditdata/' . $ALLDATAINFO['event_id']) ?>"><i class="fas fa-edit"></i> Edit Details</a></li>

                                        <?php if ($ALLDATAINFO['is_active'] == '1') : ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagelivestream/changestatus/' . $ALLDATAINFO['event_id'] . '/0') ?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
                                        <?php elseif ($ALLDATAINFO['is_active'] == '0') : ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagelivestream/changestatus/' . $ALLDATAINFO['event_id'] . '/1') ?>"><i class="fas fa-thumbs-up"></i> Active</a></li>
                                        <?php endif; ?>

                                        <!-- <?php if ($ALLDATAINFO['is_featured'] == '1') : ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagelivestream/statusfeatured/' . $ALLDATAINFO['event_id'] . '/0') ?>"><i class="fas fa-thumbs-down"></i> NotFeatured </a></li>
                                        <?php elseif ($ALLDATAINFO['is_featured'] == '0') : ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagelivestream/statusfeatured/' . $ALLDATAINFO['event_id'] . '/1') ?>"><i class="fas fa-thumbs-up"></i> Featured </a></li>
                                        <?php endif; ?> -->

                                        <li><a href="<?php echo base_url('hhjsitemgmt/eventmanagement/deletedata/' . $ALLDATAINFO['event_id']) ?>" onClick="return confirm('Want to delete Permanent!');"><i class="fas fa-trash"></i>Permanent Delete</a></li>
                                        <!-- <li><a href="<?php echo base_url('hhjsitemgmt/eventmanagement/updateStatus/' . $ALLDATAINFO['event_id']) ?>" onClick="return confirm('Want to trash!');"><i class="fas fa-trash"></i> Trash</a></li> -->
                                        <!-- <li><a href="<?php echo base_url('hhjsitemgmt/eventmanagement/duplicate/' . $ALLDATAINFO['event_id']) ?>"><i class="fas fa-edit"></i>Duplicate</a></li> -->
                                      </ul>
                                    </div>
                                  </td>
                                  <td style="width:70px;">
...
<script>
  function callMutlipleChangeStatus() {
    ...
    fetch('<?php echo base_url('hhjsitemgmt/eventmanagement/mutlipleChangeStatus'); ?>', {
        method: 'POST',
        headers: {
