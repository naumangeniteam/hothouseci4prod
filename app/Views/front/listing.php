...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <iframe allowfullscreen="allowfullscreen" scrolling="no" class="fp-iframe" src="https://mags.hothousejazzmagazine.com/af033db61d.html" style="border: 1px solid lightgray; width: 100%; height: 1000px;" sandbox="allow-scripts allow-same-origin"></iframe>
        </div>
    </div>
</div>
