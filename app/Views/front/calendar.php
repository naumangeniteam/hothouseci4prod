...
<div class="calendar-section" id="calendar-section">
               ...
               <span id="Span_form">
                  <form action="<?php echo base_url('all-products'); ?>" id="event_search_form" method="GET">
                     <div class="hhj-search-field">
                        ...
                        <input class="form-control" autocomplete=false placeholder="Search by event name" id="search-box" name="event_title">
                     ...
                     <div id="toggleSection">
                        <div class="hhj-search-fields">
                           ...
                           <div class="clear-filter">
                              <a href="#" id="clearButton"><img src=" <?= base_url('assets/front/icons/eraser.svg') ?>"  alt="user Login" /> Clear</a>
                           </div>
                        </div>
                     </div>
                  </form>
   ...
   <div class="container">
      <div class="row hhj-calender" id="html">
         <!-- This div paste  -->
         <!-- this div paste end  -->
      </div>
