        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="javascript:void(0);"><?= isset($EDITDATA) && $EDITDATA ? 'Edit' : 'Add' ?> Contact Details Content</a></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="basic-login-inner">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('event_source_id')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('event_source_id')) : ?>
                    <span for="event_source_id" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation')->getError('event_source'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('event_tags')) : ?>error<?php endif; ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('event_source')) : ?>
                    <span for="event_source" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation')->getError('event_source'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-6 col-xs-12" <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('event_source_image')) : ?>error<?php endif; ?>>
                  <div class="animation">
                    <label>Event Source Image<span class=""></span></label>
