                          ...
                          <?php if (!empty($ALLDATA)):  
                            ...
                            ?>
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <td><?= stripslashes(strip_tags($ALLDATAINFO['latitude'])) ?></td>
                                  <td><?= stripslashes(strip_tags($ALLDATAINFO['longitude'])) ?></td>
                                  <td><?= stripslashes(strip_tags($ALLDATAINFO['zipcode'])) ?></td>
                                  <td><?= stripslashes(strip_tags($ALLDATAINFO['info'])) ?></td>
