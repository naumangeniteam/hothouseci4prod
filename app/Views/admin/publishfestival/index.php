            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo base_url('hhjsitemgmt/adminmanagefestivals/addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Festival</a>
                    </div>
                    <div class="row">
        ...
        $getVenuName = $query->venue_title ?? 'N/A';
                                                        ...
                                                        ?>
                                                                <tr role="row" class="<?php echo $rowClass; ?>">
                                                                    <td><?= $i++ ?></td>
                                                                    <td style="width:100px;"><?= stripslashes(strip_tags($ALLDATAINFO['festival_name'])) ?></td>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-show" role="menu">
                                                                                ...
                                                                                <?php if ($ALLDATAINFO['is_active'] == '1') : ?>
                                                                                    <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagefestivals/changestatus/' . $ALLDATAINFO['festival_id'] . '/0') ?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
                                                                                <?php elseif ($ALLDATAINFO['is_active'] == '0') : ?>
                                                                                    <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagefestivals/changestatus/' . $ALLDATAINFO['festival_id'] . '/1') ?>"><i class="fas fa-thumbs-up"></i> Active</a></li>
                                                                                <?php endif; ?>
