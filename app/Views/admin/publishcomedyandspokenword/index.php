            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo base_url('hhjsitemgmt/adminmanagecomedyandspokenword/addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Comedy and Spoken Word</a>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-10 col-xs-12">
                                            <div class="row" style="margin:3px;">
                                                ...
                                                <a href="<?= base_url('hhjsitemgmt/adminmanagepublishcomedyandspokenword') ?>" style="margin:3px;" class="btn btn-sm btn-primary pull-right">Published Comedy and Spoken Word(<?= count($publishcomedyandspokenword) ?>)</a>
                                                <a href="<?= base_url('hhjsitemgmt/adminmanagetrashcomedyandspokenword') ?>" style="margin:3px;" class="btn btn-sm btn-primary pull-right">Trash Comedy and Spoken Word(<?= count($trashcomedyandspokenword) ?>)</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-show" role="menu">
                                                                                <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishcomedyandspokenword/addeditdata/' . $ALLDATAINFO['event_id']) ?>"><i class="fas fa-edit"></i> Edit Details</a></li>
                                                                                <?php if ($ALLDATAINFO['is_active'] == '1'): ?>
                                                                                    <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishcomedyandspokenword/changestatus/' . $ALLDATAINFO['event_id'] . '/0') ?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
                                                                                <?php elseif ($ALLDATAINFO['is_active'] == '0'): ?>
                                                                                    <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishcomedyandspokenword/changestatus/' . $ALLDATAINFO['event_id'] . '/1') ?>"><i class="fas fa-thumbs-up"></i> Active</a></li>
                                                                                <?php endif; ?>

                                                                                <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishcomedyandspokenword/deletedata/' . $ALLDATAINFO['event_id']) ?>" onClick="return confirm('Want to delete!');"><i class="fas fa-trash"></i>Permanent Delete</a></li>
                                                                                <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishcomedyandspokenword/updateStatus/' . $ALLDATAINFO['event_id']) ?>" onClick="return confirm('Want to trash!');"><i class="fas fa-trash"></i> Trash</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </td>
                                                                </tr>
