                          ...
                          <?php if (!empty($ALLDATA)): 
                            ...
                            ?>
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  <td><?= $i++ ?></td>
                                  <td><?php echo $ALLDATAINFO['admin_first_name'] . ' ' . $ALLDATAINFO['admin_middle_name'] . ' ' . $ALLDATAINFO['admin_last_name']; ?></td>
                                  <td><?= $ALLDATAINFO['admin_email'] ?></td>
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="<?php echo getCurrentControllerPath('deletedata/' . $ALLDATAINFO['admin_id']) ?>" onClick="return confirm('Want to delete!');"><i class="fas fa-trash"></i> Delete</a></li>
                                      </ul>
                                    </div>
                                  </td>
                                </tr>
