          ...
          <div class="card-body">
            <div class="basic-login-inner">
              <form id="currentPageFormSubadmin" name="currentPageFormSubadmin" class="form-auth-small" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('artist_name')) : ?>error<?php endif; ?>">
                    <label>Name<span class="required"></span></label>
                    <input type="text" name="artist_name" id="artist_name" value="<?php if (old('artist_name')) : echo old('artist_name');
                                                                                  else : echo stripslashes($EDITDATA['artist_name'] ?? '');
                                                                                  endif; ?>" class="form-control required" placeholder="Name">
                    <?php if (session('validation') && session('validation')->hasError('artist_name')) : ?>
                      <span for="artist_name" generated="true" class="help-inline"><?php echo session('validation')->getError('artist_name'); ?></span>
                    <?php endif; ?>
                  </div>
                </div>

                <div class="row">
                  <div class="form-group-inner col-lg-4 col-md-4 col-sm-6 col-xs-12" <?php if (session('validation') && session('validation')->hasError('reserve_seat_link')) : ?>error<?php endif; ?>>
                    <div class="animation">
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12" <?php if (session('validation') && session('validation')->hasError('artist_url')) : ?>error<?php endif; ?>>
                    ...
                    <?php if (session('validation') && session('validation')->hasError('artist_url')) : ?>
                      <span for="url" generated="true" class="help-inline"><?php echo session('validation')->getError('artist_url'); ?></span>
                    <?php endif; ?>
                  </div>
                </div>

                <div class="row">
                  <div class="form-group-inner col-lg-4 col-md-4 col-sm-6 col-xs-12" <?php if (session('validation') && session('validation')->hasError('cover_image')) : ?>error<?php endif; ?>>
                    <div class="animation">
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12" <?php if (session('validation') && session('validation')->hasError('cover_url')) : ?>error<?php endif; ?>>
                    ...
                    <?php if (session('validation') && session('validation')->hasError('cover_url')) : ?>
                      <span for="cover_url" generated="true" class="help-inline"><?php echo session('validation')->getError('cover_url'); ?></span>
                    <?php endif; ?>
                  </div>
                </div>

                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12" <?php if (session('validation') && session('validation')->hasError('buy_now_link')) : ?>error<?php endif; ?>>
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12" <?php if (session('validation') && session('validation')->hasError('website_link')) : ?>error<?php endif; ?>>
                    ...
                    <input type="text" name="website_link" id="website_link" value="<?php if (old('website_link')) : echo old('website_link');
                                                                                    ...
                                                                                    endif; ?>" class="form-control" placeholder="Website Link">
                    <?php if (session('validation') && session('validation')->hasError('website_link')) : ?>
                      <span for="website_link" generated="true" class="help-inline"><?php echo session('validation')->getError('website_link'); ?></span>
                    <?php endif; ?>
                  </div>
                </div>

                <div class="row">
                  <div class="form-group-inner col-lg-4 col-md-4 col-sm-6 col-xs-12" <?php if (session('validation') && session('validation')->hasError('artist_bio')) : ?>error<?php endif; ?>>
                    <div class="animation">
                      <label>Artist Bio</label>
                      <textarea name="artist_bio" id="artist_bio" rows="4" cols="80"><?php if (old('artist_bio')) : echo old('artist_bio');
                                                                                      else : echo stripslashes($EDITDATA['artist_bio']??'');
                                                                                      endif; ?></textarea>
                      <?php if (session('validation') && session('validation')->hasError('artist_bio')) : ?>
                        <span for="artist_bio" generated="true" class="help-inline"><?php echo session('validation')->getError('artist_bio'); ?></span>
                      <?php endif; ?>
                    </div>
                  </div>
                </div>
