            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);"> Duplicate Events List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                      ...
                      <select name="state" id="state" style="margin:4px;padding:2px;" class="form-control">
                        ...
                        ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?= base_url('hhjsitemgmt/adminmanageduplicates') ?>" class="btn btn-link">View All </a>
                                        </div>
                                    </form>
                                                        ...
                                                        ?>
                                                                    <tr role="row" class="<?php echo $rowClass; ?>">
                                                                        ...
                                                                        <td style="width:120px;">
                                                                            <?= stripslashes(strip_tags($ALLDATAINFO['start_date'])) ?>
                                                                        </td>
                                                                        <td style="width:120px;">
                                                                            <?= stripslashes(strip_tags($ALLDATAINFO['event_start_time'])) . ' / ' . stripslashes(strip_tags($ALLDATAINFO['event_end_time'])) ?>
                                                                        </td>
                                                                    </tr>
                                                            <?php
                                                                    $j++;
