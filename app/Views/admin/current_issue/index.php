            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Current Issue List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <?php if (!empty($ALLDATA)): 
                                                        ...
                                                        ?>
                                                                <tr role="row" class="<?php echo $rowClass; ?>">
                                                                    <td><?= $i++ ?></td>
                                                                    <td>
                                                                        <textarea class="w-100" style="height: 80px;" readonly><?= stripslashes($ALLDATAINFO['name']) ?></textarea>
                                                                    </td>
                                                                    <td>
                                                                        <?php
                                                                        // Extract the URL from the iframe code using regex
                                                                        preg_match('/src="([^"]+)"/', stripslashes($ALLDATAINFO['name']), $matches);
                                                                        $iframeSrc = isset($matches[1]) ? $matches[1] : '#'; // Default to '#' if src is not found
                                                                        ?>
                                                                        <a href="<?= $iframeSrc ?>" target="_blank" style="text-decoration: underline; color: #000000;" >View Iframe</a>
                                                                    </td>
