<?php
// Load the database connection in the view
      ...
      <div class="page-block">
        <div class="row align-items-center">
          <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="javascript:void(0);">Venue List</a></li>
            </ul>
          </div>
        </div>
      </div>
              ...
              <div class="dt-responsive table-responsive">
                <div id="simpletable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                  <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3">
                    <a href="<?php echo base_url('hhjsitemgmt/adminmanageeventlocation/export_excel'); ?>" class="btn btn-sm btn-primary" style="margin-left: 10px; margin-top: 5px;height: 40px;">Export</a>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
