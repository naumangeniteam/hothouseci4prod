          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Role</h5>
              <a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Role</a>
              </div>
              <div class="card-body">
                            ...
                            <?php if (!empty($ALLDATA)): 
                              ...
                              ?>
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  <td><?=$i++?></td>
                                  <td><?=stripslashes(strip_tags($ALLDATAINFO['role_name']))?></td>
