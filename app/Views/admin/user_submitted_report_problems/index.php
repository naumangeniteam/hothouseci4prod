      ...
      <div class="page-block">
        <div class="row align-items-center">
          <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="javascript:void(0);">User submitted Report Problems
                </a></li>
            </ul>
          </div>
        </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h5>Manage User submitted Report Problems</h5>
                          ...
                          <?php if (!empty($ALLDATA)): 
                            ...
                            ?>
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <td><?= stripslashes(strip_tags($ALLDATAINFO['report_problem'])) ?></td>
                                  <td>
                                    <div class="btn-group">
