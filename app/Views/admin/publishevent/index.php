          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Event</h5>
                <!--<a href="event_list.php?vid=0&type=3"  class="btn btn-danger">Trash Event List</a>-->
              <a href="<?php echo base_url('hhjsitemgmt/eventmanagement/addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Event</a>
              </div>
              <div class="row">
                      ...
                      <div class="widget-body bordered-left bordered-warning">
                        <form class="form-inline" method="get" id="validate" novalidate="novalidate">
                            <div class="form-group"> <span class="input-icon">
                              <input type="text" class="form-control" style="margin:6px;padding:5px;" placeholder="Event Name" name="event_name" value="">
                              </span> 
                            </div>
                            <div class="form-group"> <span class="input-icon">
                              <input type="text" class="form-control" style="margin:4px;padding:2px;" placeholder="Event Location name" name="location_name" value="">
                              </span> 
                            </div>
                           ...
                           <?php
                            ...
                            <option <?php if($EDITDATA['venue_id'] == $venue->id){ echo "selected"; } ?> value= "<?=$venue->id?>"><?=$venue->venue_title?></option>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                          <div class="row" style="margin:3px;">
                            ...
                            <a href="<?=base_url('hhjsitemgmt/adminmanagepublishevent')?>" style="margin:3px;" class="btn btn-sm btn-primary pull-right">Published Event(<?=count($publishevent)?>)</a>
                            <a href="<?=base_url('hhjsitemgmt/adminmanagetrashevent')?>" style="margin:3px;" class="btn btn-sm btn-primary pull-right">Trash Event(<?=count($trashevent)?>)</a>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                                  ...
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu dropdown-menu-show" role="menu">
                                        <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishevent/addeditdata/'.$ALLDATAINFO['event_id'])?>"><i class="fas fa-edit"></i> Edit Details</a></li>
                                        <?php if($ALLDATAINFO['is_active'] == '1'): ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishevent/changestatus/'.$ALLDATAINFO['event_id'].'/0')?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
                                        <?php elseif($ALLDATAINFO['is_active'] == '0'): ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishevent/changestatus/'.$ALLDATAINFO['event_id'].'/1')?>"><i class="fas fa-thumbs-up"></i> Active</a></li>
                                        <?php endif; ?>
                                        
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishevent/deletedata/'.$ALLDATAINFO['event_id'])?>" onClick="return confirm('Want to delete!');"><i class="fas fa-trash"></i>Permanent Delete</a></li>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagepublishevent/updateStatus/'.$ALLDATAINFO['event_id'])?>" onClick="return confirm('Want to trash!');"><i class="fas fa-trash"></i> Trash</a></li>
                                      </ul>
                                    </div>
                                  </td>
                                </tr>
