            ...
            <div class="basic-login-inner">
              <form id="currentPageFormSubadmin" name="currentPageFormSubadmin" class="form-auth-small" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="hidden" class="form-control" name="is_front" value="<?php echo (isset($EDITDATA['event_title']) ? 1 : 0); ?>">
                  </div>
                </div>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video')) : ?>error<?php endif; ?>">
                  <label>Video Link<span class=""></span></label>
                ...
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('qr_code_link')) : ?>error<?php endif; ?>">
              ...
              <!-- <div class="row">
                <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video2')) : ?>error<?php endif; ?>">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video3')) : ?>error<?php endif; ?>">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('reserve_seat_link')) : ?>error<?php endif; ?>">
              ...
              <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('artist_id')) : ?>error<?php endif; ?>">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('user_first_name')) : ?>error<?php endif; ?>">
                  <label>Contact Person First Name <span class="required">*</span></label>
                  <input type="text" name="user_first_name" id="user_first_name" value="<?php if (old('user_first_name')) : echo old('user_first_name');
                                                                                        else : echo stripslashes($EDITDATA['user_first_name']);
                                                                                        endif; ?>" class="form-control " placeholder="Contact Person First Name">
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('user_first_name')) : ?>
                    <span for="user_first_name" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation')->getError('user_first_name'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('user_last_name')) : ?>error<?php endif; ?>">
                  <label>Contact Person Last Name <span class="required">*</span></label>
                  <input type="text" name="user_last_name" id="user_last_name" value="<?php if (old('user_last_name')) : echo old('user_last_name');
                                                                                      else : echo stripslashes($EDITDATA['user_last_name']);
                                                                                      endif; ?>" class="form-control " placeholder="Contact Person Last Name">
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('user_last_name')) : ?>
                    <span for="user_last_name" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation')->getError('user_last_name'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('email')) : ?>error<?php endif; ?>">
                  <label>Contact Email <span class="required">*</span></label>
                  <input type="text" name="email" id="email" value="<?php if (old('email')) : echo old('email');
                                                                    else : echo stripslashes($EDITDATA['email']);
                                                                    endif; ?>" class="form-control " placeholder="Contact Email">
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('email')) : ?>
                    <span for="email" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation')->getError('email'); ?></span>
                  <?php endif; ?>
                </div>
              </div>
  ...
  function getLocationId() {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $("#location_address").val(response.data.location_address);
        $("#longitude").val(response.data.longitude);
        $("#latitude").val(response.data.latitude);
        $("#phone_number").val(response.data.phone_number);
        $("#website").val(response.data.website);
        $("#venue_id").val(response.data.venue_id);
        $("#jazz_types_id").val(response.data.jazz_types_id);
        $("#artist_id").val(response.data.artist_id);
