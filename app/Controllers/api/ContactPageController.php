...
class ContactPageController extends BaseController
{
     ...
     */
    public function getContactPageList()
    {
        ...
        if (requestAuthenticate(APIKEY, 'GET')) {
            ...
            $result['banner'] = $this->commonModel->getData(
                'multiple',
                'banner_tbl',
                ['where' => ['page_name' => 'Contact Page', 'is_active' => '1']],
                'id DESC',
                6
            );

            // Contact Section
            $result['contact_details_tbl'] = $this->commonModel->getData(
                'multiple',
                'contact_details_tbl',
                ['where' => ['is_active' => '1']]
            );
            ...
            // Advertising Section
            $result['advertisement_tbl'] = $this->commonModel->getData(
                'multiple',
                'advertisement_tbl',
                ['where' => ['is_active' => '1']]
            );
            ...
            // Footer Section
            $result['footer_tbl'] = $this->commonModel->getData(
                'multiple',
                'footer_tbl',
                ['where' => ['is_active' => '1']]
            );
