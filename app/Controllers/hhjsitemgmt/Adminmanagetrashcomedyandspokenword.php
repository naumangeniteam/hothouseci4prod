...
class Adminmanagetrashcomedyandspokenword extends BaseController {
...
$this->lang->setLocale('admin');
	...
	{	
		...
		$data['error'] 						= 	'';
		$data['activeMenu'] 				= 	'adminmanagetrashcomedyandspokenword';
		$data['activeSubMenu'] 				= 	'adminmanagetrashcomedyandspokenword';
		...
		$baseUrl 							= 	base_url().'hhjsitemgmt/adminmanagetrashcomedyandspokenword/index';
       ...
       if ($this->request->getUri()->getSegment($uriSegment)) :
		...
		$this->layouts->admin_view('trashcomedyandspokenword/index',array(),$data);
	}	// END OF FUNCTION
