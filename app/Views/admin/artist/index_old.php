      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form id="Data_Form" name="Data_Form" method="get"  id="validate" novalidate="novalidate">  
            <!-- //action="<?php echo $forAction; ?>" -->
                ...
                <div id="simpletable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                  <div class="row mb-3">
                    ...
                    <div class="form-group">
                      ...
                      <a href="<?= base_url('hhjsitemgmt/adminmanageartist') ?>" class="btn btn-link">View All </a>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                          ...
                          <tbody>
                            ...
                            ?>
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <td><?= stripslashes(strip_tags($ALLDATAINFO['buy_now_link'])) ?></td>
                                  <td><?= stripslashes(strip_tags($ALLDATAINFO['website_link'])) ?></td>
