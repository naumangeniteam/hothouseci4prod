...
<div class="row">
    <div class="col-lg-12 col-12">
        <div class="single-banner-img">
            <?php if (!empty($artist_tbl[0]['artist_image'])) : ?>
                <img src="<?php echo base_url('assets/front/img/artistimage/' . $artist_tbl[0]['artist_image']); ?>" class="img-fluid" alt="Thumb Image">
            <?php else : ?>
                <img src="<?php echo base_url('assets/front/img/artistimage/events.jpg'); ?>" class="img-fluid" alt="Default Image">
            <?php endif; ?>
        </div>
                                    ...
                                    <div id="event_29493" class="eventon_list_event" event_id="29493" itemscope="" itemtype="https://schema.org/Event">
                                            ...
                                            <item style="display:none" itemprop="location" itemscope="" itemtype="">
                                                <span itemprop="address" itemscope="" itemtype="">
                                                    <item itemprop="streetAddress">
                                                        11th Street Bar , Lower Manhattan , 510 E 11th St, New York, NY 10009 </item>
                                                </span>
                                            </item>
                                        </div>
                                        <a id="evc_141496200013450" class="evcal_list_a desc_trig mul_val gmaponload evo_brooklyn" data-exlk="1" style="border-color: #ffa800" data-gmtrig="1" data-ux_val="none" data-gmstat="1">
                                            ...
                                            <span class="evcal_desc" latlon="1" latlng="40.7280118,-73.98129159999999" add_str="510 E 11th St, New York, NY 10009" data-location_name="11th Street Bar">
                                                ...
                                                <span class="evcal_desc_info"> <em class="evcal_time"><?php echo  strtoupper($event_start_time);   ?> - <?php echo  strtoupper($event_end_time);   ?>
                                        ...
                                        <div class="event_description evcal_eventcard">
                                                            ...
                                                            <div class="evcal_evdata_row evo_time">
                                                                ...
                                                                <div class="evcal_evdata_cell">
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <?php echo $day;   ?> (<?php echo substr(strtoupper($day_name), 0, 3);   ?>) <?php echo  strtoupper($event_start_time);   ?> - <?php echo $day1;   ?> (<?php echo substr(strtoupper($day_name), 0, 3);  ?>) <?php echo  strtoupper($event_end_time);   ?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="evorow bordb">
                                                <div class="tb">
                                                    <div class="tbrow">
                                                        <a class="evcal_col50 dark1 bordr evo_clik_row" href=<?= $item['buy_now_link'] ?>>
                                                        ...
                                                        <div class="evo_ics evcal_col50 dark1 evo_clik_row">
                                                            ...
                                                            <a href="<?= $item['reserve_seat_link'] ?>">Reserve Seat Now Link </a>
                                                        </div>
                                                    </div>
                                                    <div class="tbrow">
                                                        <a class="evcal_col50 dark1 bordr evo_clik_row" href=<?= $item['video'] ?>>
                                                            <span class="evcal_evdata_row ">
                                                                <span class="evcal_evdata_icons"><i class="fa fa-link"></i></span>
                                                                <h3 class="evo_h3">
                                                                    Video Link 1</h3>
                                                        ...
                                                        <div class="evo_ics evcal_col50 dark1 evo_clik_row">
                                                            <!--		 <a href="#" class="evo_ics_nCal" title="Add to your calendar">Calendar</a> -->
                                                            <a href="<?= $item['video2'] ?>">Video Link 2 </a>
                                                        </div>
                                                    </div>
                                                    <div class="tbrow">
                                                        <a class="evcal_col50 dark1 bordr evo_clik_row" href=<?= $item['video3'] ?>>
                                                            <span class="evcal_evdata_row ">
                                                                <span class="evcal_evdata_icons"><i class="fa fa-link"></i></span>
                                                                <h3 class="evo_h3">Video Link 3 </h3>
                                                            </span>
                                                        </a>
                                                    </div>
                                                </div>
