                                  ...
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu dropdown-menu-show" role="menu">
                                           <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagetrashcomedyandspokenword/deletedata/'.$ALLDATAINFO['event_id'])?>" onClick="return confirm('Want to delete Permanent!');"><i class="fas fa-trash"></i>Permanent Delete</a></li>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagetrashcomedyandspokenword/restore/'.$ALLDATAINFO['event_id'])?>" onClick="return confirm('Want to Restore!');"><i class="fa fa-suitcase"></i>Restore</a></li>
                                      </ul>
                                    </div>
                                  </td>
                                </tr>
