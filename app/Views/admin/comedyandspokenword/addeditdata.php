          ...
          <div class="card-body">
            <div class="basic-login-inner">
              <form id="currentPageFormSubadmin" name="currentPageFormSubadmin" class="form-auth-small" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row mt-2">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('event_title')) ? 'error' : '' ?>">
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12  <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('start_date')) ? 'error' : '' ?>">
                    ...
                    <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('start_date')) : ?>
                      <span for="start_date" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('start_date'); ?></span>
                    <?php endif; ?>
                  </div>

                  <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('end_date')) ? 'error' : '' ?>">
                    ...
                    <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('end_date')) : ?>
                      <span for="end_date" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('end_date');  ?></span>
                    <?php endif; ?>
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('time_permission')) ? 'error' : '' ?>">
                    ...
                    <div class="radio">
                      ...
                      <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('time_permission')) : ?>
                        <span for="time_permission" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('time_permission'); ?></span>
                      <?php endif; ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('description')) ? 'error' : '' ?>">
                    ...
                    <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('description')) : ?>
                      <span for="description" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('description'); ?></span>
                    <?php endif; ?>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-10 col-md-8 col-sm-12 col-xs-12  <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('repeating_event')) ? 'error' : '' ?>">
              ...
              <?php } ?>
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12   <?= ($EDITDATA['repeating_event'] == 'Yes') ? 'show' : 'hide'; ?><?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('content1')) ? 'error' : '' ?>" id="frequency">
                ...
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12  <?= ($EDITDATA['repeating_event'] == 'Yes') ? 'show' : 'hide'; ?><?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('no_of_repeat')) ? 'error' : '' ?>" id="repeat">
                  <label>Number of repeats:<span class="required">*</span></label>
                  <input type="number" min="0" step="1" name="no_of_repeat" id="no_of_repeat" value="<?php if (old('no_of_repeat')) : echo old('no_of_repeat');
                                                                                  else : echo stripslashes($EDITDATA['no_of_repeat']);
                                                                                  endif; ?>" class="form-control required" placeholder="Number of repeats:">
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('no_of_repeat')) : ?>
                    <span for="no_of_repeat" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('no_of_repeat'); ?></span>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-1 additional_fields" style="display: none;">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('virtual_event_price')) : ?>
                    <span for="virtual_event_price" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('virtual_event_price'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12  additional_fields" style="display: none;">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('virtual_event_link')) : ?>
                    <span for="virtual_event_link" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('virtual_event_link'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('content1')) ? 'error' : '' ?>" id="frequency">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('save_location_id')) : ?>
                    <span for="save_location_id" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('save_location_id'); ?></span>
                  <?php endif; ?>
                </div>

                <div class="form-group-inner  col-lg-6 col-md-6 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('location_name')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('location_name')) : ?>
                    <span for="location_name" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('location_name'); ?></span>
                  <?php endif; ?>
                </div>
              ...
              <div class="row">
                <div class="form-group-inner  col-lg-6 col-md-6 col-sm-12 col-xs-12 <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('location_address')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('location_address')) : ?>
                    <span for="location_address" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('location_address'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('latitude')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('latitude')) : ?>
                    <span for="latitude" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('latitude'); ?></span>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('longitude')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('longitude')) : ?>
                    <span for="longitude" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('longitude'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12<?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('website')) ? 'error' : '' ?>">
                  <label>Website:</label>
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('website')) : ?>
                    <span for="website" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('website'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('phone_number')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('phone_number')) : ?>
                    <span for="phone_number" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('phone_number'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('content1')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('venue_id')) : ?>
                    <span for="venue_id" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('venue_id'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('cover_charge')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('cover_charge')) : ?>
                    <span for="cover_charge" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('cover_charge'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12<?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('set_time')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('set_time')) : ?>
                    <span for="set_time" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('set_time'); ?></span>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video')) : ?>
                    <span for="video" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video'); ?></span>
                  <?php endif; ?>
                </div>

                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video2')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video2')) : ?>
                    <span for="video2" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video2'); ?></span>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video3')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video3')) : ?>
                    <span for="video3" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('video3'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('buy_now_link')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('buy_now_link')) : ?>
                    <span for="buy_now_link" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('buy_now_link'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-innercol-lg-4 col-md-4 col-sm-12 col-xs-12" <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('cover_image')) ? 'error' : '' ?>>
                  <div class="animation">
                ...
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('cover_url')) : ?>
                    <span for="cover_url" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('cover_url'); ?></span>
                  <?php endif; ?>
                </div>
              </div>

              <div class="row">
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('reserve_seat_link')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('reserve_seat_link')) : ?>
                    <span for="reserve_seat_link" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('reserve_seat_link'); ?></span>
                  <?php endif; ?>
                </div>
                <div class="form-group-inner col-lg-6 col-md-6 col-sm-12 col-xs-12 <?= (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('event_tags')) ? 'error' : '' ?>">
              ...
              <div class="row">
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('qr_code_link')) ? 'error' : '' ?>">
                  ...
                  <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('qr_code_link')) : ?>
                    <span for="qr_code_link" generated="true" class="help-inline"><?php echo session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('qr_code_link'); ?></span>
                  <?php endif; ?>
                </div>
                ...
                <div class="form-group-inner col-lg-4 col-md-4 col-sm-12 col-xs-12 <?=(session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('artist_id')) ? 'error' : '' ?>">
...
<script>
  function getLocationId() {
    ...
    $.ajax({
      type: 'GET',
      dataType: 'json',
      url: "<?= base_url('hhjsitemgmt/adminmanagecomedyandspokenword/location') ?>",
      data: data,
