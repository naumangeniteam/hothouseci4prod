...
class Adminmanagegethh extends BaseController {
	...
	{	
		...
		$data['error'] 						= 	'';
		$data['activeMenu'] 				= 	'adminmanagegethh';
		$data['activeSubMenu'] 				= 	'adminmanagegethh';
		...
		$this->layouts->set_title('Manage Get Hot House page');
		$this->layouts->admin_view('gethothouse/index',array(),$data);
	}	// END OF FUNCTION
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']		=	$this->common_model->getDataByParticularField('get_hh_tbl','id',(int)$editId);
		else:
		...
		$this->layouts->set_title('Manage Get Hothouse Page');
		$this->layouts->admin_view('gethothouse/addeditdata',array(),$data);
	}	// END OF FUNCTION	
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->editData('get_hh_tbl',$param,'id',(int)$changeStatusId);
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->deleteData('get_hh_tbl','id',(int)$deleteId);
