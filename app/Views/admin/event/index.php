                ...
                <div class="widget-body bordered-left bordered-warning">
                  <form class="form-inline" method="get" id="validate" novalidate="novalidate">
                    ...
                    <div class="form-group">
                      ...
                      <a href="<?= base_url('hhjsitemgmt/eventmanagement') ?>" class="btn btn-link">View All </a>
                    </div>
                  </form>
                                  ...
                                  <td style="width:100px;">
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu dropdown-menu-show" role="menu">
                                        <li><a href="<?php echo base_url('hhjsitemgmt/eventmanagement/addeditdata/' . $ALLDATAINFO['event_id']) ?>"><i class="fas fa-edit"></i> Edit Details</a></li>

                                        <?php if ($ALLDATAINFO['is_active'] == '1') : ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/eventmanagement/changestatus/' . $ALLDATAINFO['event_id'] . '/0') ?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
                                        <?php elseif ($ALLDATAINFO['is_active'] == '0') : ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/eventmanagement/changestatus/' . $ALLDATAINFO['event_id'] . '/1') ?>"><i class="fas fa-thumbs-up"></i> Active</a></li>
                                        <?php endif; ?>

                                        <?php if ($ALLDATAINFO['is_featured'] == '1') : ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/eventmanagement/statusfeatured/' . $ALLDATAINFO['event_id'] . '/0') ?>"><i class="fas fa-thumbs-down"></i> NotFeatured </a></li>
                                        <?php elseif ($ALLDATAINFO['is_featured'] == '0') : ?>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/eventmanagement/statusfeatured/' . $ALLDATAINFO['event_id'] . '/1') ?>"><i class="fas fa-thumbs-up"></i> Featured </a></li>
                                        <?php endif; ?>
