          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Venue </h5>
              <a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Venue</a>
              </div>
              <div class="card-body">
                            ...
                            <tbody>
                              ...
                              ?>
                               <tr role="row" class="<?php echo $rowClass; ?>">
                                  <td><?=$i++?></td>
                                  <td><?=stripslashes(strip_tags($ALLDATAINFO['venue_title']))?></td>
                                  <td><?=$ALLDATAINFO['position']?></td>
