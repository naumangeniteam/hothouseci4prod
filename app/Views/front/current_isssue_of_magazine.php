...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <iframe allowfullscreen="allowfullscreen" scrolling="no" class="fp-iframe" src="https://mags.hothousejazzmagazine.com/7c5e517385.html" style="border: 1px solid lightgray; width: 100%; height: 800px;"  sandbox="allow-scripts allow-same-origin"></iframe>
        </div>
    </div>
</div>
