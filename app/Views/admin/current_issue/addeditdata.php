            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo correctLink('webinarILCADMData', getCurrentControllerPath('index')); ?>"> Current Issue List</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);"><?= $EDITDATA ? 'Edit' : 'Add' ?> Current Issue</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <form id="currentPageFormSubadmin" name="currentPageFormSubadmin" class="form-auth-small" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 <?php if (session()->getFlashdata('validation') && session()->getFlashdata('validation')->hasError('name')) : ?>error<?php endif; ?>">
                                        <label>Iframe Code<span class="required"></span></label>
                                        <textarea name="name" id="name" class="form-control required" placeholder="Enter here..."><?php
                                            if (old('name')) :
                                                 echo old('name');
                                            else :
                                                 echo stripslashes($EDITDATA['name']);
                                            endif;
                                        ?></textarea>
