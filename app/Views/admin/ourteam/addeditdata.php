  ...
  <div class="pcoded-content">
      ...
      <div class="page-block">
        <div class="row align-items-center">
          <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo correctLink('webinarILCADMData', getCurrentControllerPath('index')); ?>">Our Team Member List</a></li>
              <li class="breadcrumb-item"><a href="javascript:void(0);"><?= $EDITDATA ? 'Edit' : 'Add' ?>Our Team Members</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h5><?= $EDITDATA ? 'Edit' : 'Add' ?>Our Team members</h5>
          </div>
          <div class="card-body">
              ...
              <form id="currentPageFormSubadmin" name="currentPageFormSubadmin" class="form-auth-small" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="form-group-inner col-lg-8 col-md-8 col-sm-12 col-xs-12 
                    <?php if (session('validation') && session('validation')->hasError('title')) : ?>error<?php endif; ?>">
    
    <label>Title<span class="required">*</span></label>
    
    <input type="text" name="title" id="title" 
           value="<?= old('title') ?? stripslashes($EDITDATA['title'] ?? '') ?>" 
           class="form-control required" placeholder="Page title">
    
    <?php if (session('validation') && session('validation')->hasError('title')) : ?>
        <span for="title" generated="true" class="help-inline">
    ...
    <?php endif; ?>
                ...
                <div class="row" id="show">
                  <div class="form-group-inner col-lg-12 col-md-12 col-sm-12 col-xs-12 <?php if (session('validation') && session('validation')->hasError('content')) : ?>error<?php endif; ?>" id="show">
