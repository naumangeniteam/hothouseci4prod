            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Get Hothouse List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Hothouse</h5>
              <a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Get Hothouse</a>
              </div>
              <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                            ...
                            <?php if (!empty($ALLDATA)):  
                              $i=$first; 
                              $j=0; foreach($ALLDATA as $ALLDATAINFO): 
