            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home Page Slider Image List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Home Page Slider Image</h5>
              <a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Content</a>
              <button type="submit" name="inactivebtn" class="btn btn-sm btn-primary pull-right" style="margin-right: 13px;">Multiple Inactive</button>
              <button type="submit" name="activebtn" class="btn btn-sm btn-primary pull-right" style="margin-right: 13px;">Multiple Active</button>
             </div>
              <div class="card-body">
                    ...
                    <div id="simpletable_wrapper" class="dataTables_wrapper dt-bootstrap4">
             		...
             		<table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                            <thead>
                              <tr role="row">
                              <th>Sr.No.</th>
                              <th>Multiple Active</th>
                              <th>Multiple Inactive</th>
                              <th>Image</th>
                                <th>Date</th>
                                 <th>Position</th>
                                <th>Status</th>
                            ...
                            <tbody>
                              ...
                              ?>
                               ...
                               <td><?=$i++?></td>
                                ...
                                <td>
                                    <?php if($ALLDATAINFO['is_active'] == '0'){ ?>
                                  ...
                                  <?php if($ALLDATAINFO['image'] == ''){ ?>
                                    ...
                                    <?php }else{ ?>
                                      <td><img src="<?= $ASSET_URL?>/front/img/homeimage/<?=$ALLDATAINFO['image']?>" width="200px"></td>
                                    <?php } ?>
                                   
                                    <td><?=$ALLDATAINFO['creation_date'];?></td>
