                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                          <div class="row" style="margin:3px;">
                            ...
                            <a href="<?=base_url('hhjsitemgmt/adminmanagetrashevent')?>" style="margin:3px;" class="btn btn-sm btn-primary pull-right">Trash Event(<?=sizeof($trashevent)?>)</a>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                                  ...
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu dropdown-menu-show" role="menu">
                                           <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagetrashevent/deletedata/'.$ALLDATAINFO['event_id'])?>" onClick="return confirm('Want to delete Permanent!');"><i class="fas fa-trash"></i>Permanent Delete</a></li>
                                          <li><a href="<?php echo base_url('hhjsitemgmt/adminmanagetrashevent/restore/'.$ALLDATAINFO['event_id'])?>" onClick="return confirm('Want to Restore!');"><i class="fa fa-suitcase"></i>Restore</a></li>
                                      </ul>
                                    </div>
                                  </td>
                                </tr>
