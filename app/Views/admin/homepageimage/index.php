            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home Page Image List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Home Page Image</h5>
              <a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Home Page Image</a>
              </div>
              <div class="card-body">
                              ...
                              ?>
                               <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <?php if($ALLDATAINFO['image'] == ''){ ?>
                                    ...
                                    <?php } ?>
                                    <?php if($ALLDATAINFO['image2'] == ''){ ?>
                                    <td><img src="<?= $ASSET_URL?>/front/img/image213X213.jpg" width="100px"></td> 
                                    <?php }else{ ?>
                                      <td><img src="<?= $ASSET_URL?>/front/img/homeimage/<?=$ALLDATAINFO['image2']?>" width="200px"></td>
                                    <?php } ?>
