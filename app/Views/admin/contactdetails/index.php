            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Contact Details List</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <?php if (!empty($ALLDATA)): 
                              ...
                              ?>
                               <tr role="row" class="<?php echo $rowClass; ?>">
                                  <td><?=$i++?></td>
                                  <td><?=stripslashes(strip_tags($ALLDATAINFO['phone']))?></td>
                                  <td><?=stripslashes(strip_tags($ALLDATAINFO['address']))?></td>
                                  <td><?=stripslashes(strip_tags($ALLDATAINFO['content1']))?></td>
                                  <td><?=stripslashes(strip_tags($ALLDATAINFO['content2']))?></td>
